...
/**
 * @generated from protobuf message memento.URLResult
 */
...
export interface KeywordResult {
    ...
    count: number;
    /**
     * @generated from protobuf field: google.protobuf.Timestamp visit_time = 3;
     */
    visitTime?: Timestamp;
}
/**
...
class URLResult$Type extends MessageType<URLResult> {
    constructor() {
        super("memento.URLResult", [
    ...
    create(value?: PartialMessage<URLResult>): URLResult {
        const message = { domain: 0, address: "", keyword: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<URLResult>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: URLResult): URLResult {
    ...
    internalBinaryWrite(message: URLResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message memento.URLResult
 */
export const URLResult = new URLResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class KeywordResult$Type extends MessageType<KeywordResult> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 count */ 2:
                    ...
                    break;
                case /* google.protobuf.Timestamp visit_time */ 3:
                    message.visitTime = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.visitTime);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: KeywordResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.visitTime)
            Timestamp.internalBinaryWrite(message.visitTime, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
