...
@kotlin.jvm.JvmName("-initializelistUrlsResponse")
public inline fun listUrlsResponse(block: memento.ListUrlsResponseKt.Dsl.() -> kotlin.Unit): memento.Url.ListUrlsResponse =
  memento.ListUrlsResponseKt.Dsl._create(memento.Url.ListUrlsResponse.newBuilder()).apply { block() }._build()
public object ListUrlsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: memento.Url.ListUrlsResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: memento.Url.ListUrlsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): memento.Url.ListUrlsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun memento.Url.ListUrlsResponse.copy(block: memento.ListUrlsResponseKt.Dsl.() -> kotlin.Unit): memento.Url.ListUrlsResponse =
  memento.ListUrlsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

val memento.Url.ListUrlsResponseOrBuilder.cursorOrNull: memento.Types.URLCursor?
