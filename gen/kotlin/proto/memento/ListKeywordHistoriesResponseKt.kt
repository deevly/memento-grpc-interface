...
@kotlin.jvm.JvmName("-initializelistKeywordHistoriesResponse")
public inline fun listKeywordHistoriesResponse(block: memento.ListKeywordHistoriesResponseKt.Dsl.() -> kotlin.Unit): memento.Keyword.ListKeywordHistoriesResponse =
  memento.ListKeywordHistoriesResponseKt.Dsl._create(memento.Keyword.ListKeywordHistoriesResponse.newBuilder()).apply { block() }._build()
public object ListKeywordHistoriesResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: memento.Keyword.ListKeywordHistoriesResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: memento.Keyword.ListKeywordHistoriesResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): memento.Keyword.ListKeywordHistoriesResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun memento.Keyword.ListKeywordHistoriesResponse.copy(block: memento.ListKeywordHistoriesResponseKt.Dsl.() -> kotlin.Unit): memento.Keyword.ListKeywordHistoriesResponse =
  memento.ListKeywordHistoriesResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
